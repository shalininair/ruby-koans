...
class AboutToStr < Neo::Koan
  ...
  # method to_str (as defined in the example above) is enough for objects of the class to be treated as strings
  # an object that can respnd to method to_str can be treated as an object of class String
