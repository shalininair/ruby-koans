...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # "__send__"  can't be over-ridden (even by accident). 
    #Ruby's stdlib's socket class has its own implemetation of "send", but "_send_" is the same throughout Ruby
  end
  ...
  def test_sending_undefined_messages_to_a_typical_object_results_in_errors
    ...
    assert_match(/foobar/, "undefined method 'foobar' for")
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    assert_match(/foobar/, "method 'foobar' ")
