...
class AboutClassMethods < Neo::Koan
  ...
  # while self.method is a shoter way to create class methods, class << self opens up the singleton class 
  # refer https://stackoverflow.com/questions/2505067/class-self-idiom-in-ruby/2505077#2505077
  #
