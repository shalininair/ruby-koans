...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # inject performs a binary operation specified by a block or symbol on all elements in the array or enumarable
    # inject takes two block arguments |result,element|. 
    #The first blk arg result is optional, defaults to zero amd holds the value of the opration
    #the second blk arg is the element of the array/ enum 
