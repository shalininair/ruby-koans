...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # If we required the matching function to match the whole string  e.g "azc"[/^z*$/] then * would fail
  end
  ...
  #
  # Why?
  # Repetition operators are greedy because they match as many occurences as possible.
  ...
  # A character clas [...] enables the matching of one character while alternation enables matching of strings of length 1 or more
